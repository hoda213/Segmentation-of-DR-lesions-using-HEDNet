...
def clahe_gridsize(image_path, mask_path, denoise=False, 
contrastenhancement=False, brightnessbalance=None, cliplimit=None, gridsize=8):
    ...
    Inputs:
      ...
      cliplimit: The pixel (high contrast) limit applied to CLAHE processing. 
    ...
    if contrastenhancement:
      ...
      planes = clahe.apply(lab_planes[0])
      lab_planes = [planes,lab_planes[1],lab_planes[2]]
